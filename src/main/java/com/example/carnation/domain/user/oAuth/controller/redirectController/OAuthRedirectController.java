package com.example.carnation.domain.user.oAuth.controller.redirectController;
...
import com.example.carnation.domain.user.oAuth.service.OAuthService;
...
public class OAuthRedirectController {
    ...
    public ApiResponse<TokenDto> socialLogin(
            ...
            @RequestParam OAuthProviderNameType oAuthProviderName,
            @Parameter(
                    name = "code",
